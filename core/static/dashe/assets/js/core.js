...
$(document).ready(function(){
    ...
    function pay(){
        $(document).on('click', '#card_submit', function(){
            let amount = $('#card_amount').val();
            let csrftoken = $("[name=csrfmiddlewaretoken]").val();
                ...
                if (amount != 0){
                    if (amount >= 100 ){
                        ...
                        iziToast.error({
                            title: 'Error',
                            position: 'topRight', 
                            message: 'Minimum Amount Is 100 Naira',
                            });
                    }
                };
            };
    ...
    function copyauto(){
        $(document).on('click', '#auto_button', function(){
            let num = $('#auto_num').val();
            console.log('clicked')
    ...
    function copyreflink(){
        $(document).on('click', '#ref_link', function(){
            let link = $('#ref_link').val();
            console.log('clicked')
...
// Floating chat icon --Customer Support
...
$(document).ready(function () {
    ...
    $(function () {
      $('#WAButton').floatingWhatsApp({
        phone: '+23490', //WhatsApp Business phone number International format-
        //Get it with Toky at https://toky.co/en/features/whatsapp.
        headerTitle: 'Chat us on WhatsApp!', //Popup Title
